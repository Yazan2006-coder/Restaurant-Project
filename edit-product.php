...
<head>
    ...
    <title>Edit Product — Fritandel Admin</title>
...
<body>
    ...
    <div class="admin-container">
        ...
        <?php if ($product): ?>
            <form method="POST" action="edit-product.php?id=<?php echo $product['id']; ?>" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="naam">Product Name *</label>
                    <input type="text" id="naam" name="naam" value="<?php echo htmlspecialchars($product['naam']); ?>" required autofocus>
                </div>

                <div class="form-group">
                    <label for="beschrijving">Description *</label>
                    <textarea id="beschrijving" name="beschrijving" required><?php echo htmlspecialchars($product['beschrijving']); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="categorie" name="categorie" required>
                        ...
                        <option value="Signature" <?php echo $product['categorie'] === 'Signature' ? 'selected' : ''; ?>>Signature</option>
                        <option value="Hot & Spicy" <?php echo $product['categorie'] === 'Hot & Spicy' ? 'selected' : ''; ?>>Hot & Spicy</option>
                        <option value="Premium" <?php echo $product['categorie'] === 'Premium' ? 'selected' : ''; ?>>Premium</option>
                        <option value="Vegan" <?php echo $product['categorie'] === 'Vegan' ? 'selected' : ''; ?>>Vegan</option>
                        <option value="Classic" <?php echo $product['categorie'] === 'Classic' ? 'selected' : ''; ?>>Classic</option>
                        <option value="New" <?php echo $product['categorie'] === 'New' ? 'selected' : ''; ?>>New</option>
                    </select>
                </div>

                <div class="form-group">
                    <label for="prijs">Price (€) *</label>
                    <input type="number" id="prijs" name="prijs" step="0.01" min="0.01" value="<?php echo number_format($product['prijs'], 2, '.', ''); ?>" required>
                </div>
